...
est_raster <- terra::rast("Ensemble_1980-2023_EST_epsg_4326.tif") 
# Read in invading model raster
inv_raster <- terra::rast("Ensemble_1980-2023_INV_epsg_4326.tif") 
...
output$dl <- downloadHandler(
  ...
  filename = function(){
    paste0(input$model_select, "_", input$year_select, "_custom_map_", Sys.Date(), ".png")
    },
...
output$dl2 <- downloadHandler(
  # Create the output file name
  filename = function() {
    paste0("custom_summary_", Sys.Date(), ".csv")
  },
